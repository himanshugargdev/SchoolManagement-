...
if(isset($_POST['new'])){ 
  ...
  echo'<script>swal("Status!","Unble to Add New Subject.","error"); </script>';
  }else{
                ...
                <div class="card-body p-3">
                  <div class="row">
                     ...
                     <?php
                       if(isset($subj)){
                        ?>
                    <a class="btn bg-gradient-primary mb-0" href="managesubject.php"><i class="material-icons text-sm"></i>Reset</a>
                  ...
                  <div class="col-md-12 mb-md-0 mb-4">
                      <div class="card card-body border card-plain border-radius-lg  "> 
                       ...
                       <div class="mb-3">
                          ...
                          <select name="cls" class="form-control form-control-lg"   >
                            ...
                            ?> 
                            <option value="<?=$row['id']?>" <?php if($row['id']==$cls)echo "selected  " ?>  ><?=$row['class_name']?></option>
                              <?php }?>
                               
                          </select>
                        </div> 
                         <div class="mb-3 text-end">
                      <button type="submit" class="btn bg-gradient-primary mb-0" href="javascript:;"><i class="material-icons text-sm"></i>Show Subject</button  >
                    </div>
                       </form>  
                        </div>
                       </div>
                        ...
                        if(mysqli_num_rows($sql)>0){
                         ...
                         <div class="col-md-12 mb-md-0 mb-4 event-item">
                           ...
                           <p><span><b>Discription:</b></span>  <?= $subj_row['discription']?></p> 
                            ...
                            <div class="col-12 text-end"> 
                           <a class="btn bg-gradient-primary mb-0" href="managesubject.php?cls=<?=$cls?>&subj=<?= $subj_row['id']?>"><i class="material-icons text-sm"></i>update</a>
                          </div>
                    ...
                    <div class="col-md-6 mb-md-0 mb-4">
                      <div class="card card-body border card-plain border-radius-lg  " > 
                        ...
                        <div class="card card-body border card-plain border-radius-lg  " style="overflow-y: scroll;min-height: 300px; max-height: 500px;"> 
                       <form   method="post">
                       <div class="mb-3">
                          <label  class="form-label">Subject Name</label>
                          <input type="text"  name="subject_name" class="form-control form-control-lg" value="<?=$subject_name ?>"  placeholder="  Name">
                        </div> 
                       <div class="mb-3">
                          <label  class="form-label">Subject Title</label>
                          <input type="text"  name="subject_title"class="form-control form-control-lg" value="<?=$subject_title ?>"  placeholder="  title">
                        </div> 
                        
                        <div class="mb-3">
                          <label class="form-label">Subject Desc...</label>
                          <textarea  name="discription" placeholder="Discription"  class="form-control form-control-lg" rows="5"><?=$discription?></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <select name="class_id" class="form-control form-control-lg"   >
                            ...
                            <?php  
                                  ...
                                  while ($row = mysqli_fetch_assoc($sql)) { 
                                  ?> 
                                  <option value="<?=$row['id']?>" <?php if($row['id']==$class_id)echo "selected  " ?>  ><?=$row['class_name']?></option>
                                    <?php }?>               
                       ...
                       <div class="mb-3 text-end">
                         <?php 
                          if(isset($subj)){
                            ?>
                              <input style="display:none;" type="number" class="form-control form-control-lg" value="<?=$subj ?>"  name="subj" required>
                              <button class="btn bg-gradient-primary mb-0" name="update" ><i class="material-icons text-sm"></i>Update Subject</button>
                            <?php
                          }else{
                            ?>
                            <button class="btn bg-gradient-primary   mb-0" name="new" ><i class="material-icons text-sm"></i>New Subject</button>
                            <?php
                          }                
                          ?>
                          </div>
