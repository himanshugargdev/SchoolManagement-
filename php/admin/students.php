                      ...
                      <div class="card card-body border card-plain border-radius-lg  "> 
                       ...
                       <div class="mb-3">
                          ...
                          <select name="cls" class="form-control form-control-lg"   >
                            ...
                            ?> 
                            <option value="<?=$row['id']?>" <?php if($row['id']==$class)echo "selected disabled" ?>  ><?=$row['class_name']?></option>
                              <?php }?>
                               
                          </select>
                        </div> 
                         <div class="mb-3 text-end">
                      <button type="submit" class="btn bg-gradient-primary mb-0" href="javascript:;"><i class="material-icons text-sm"></i>Show Students</button  >
                    </div>
                       </form>  
                        </div>
                       </div>
