...
if(isset($_POST['new'])){ 
    ...
    if(!mysqli_query($conn,$sql))  {
    echo'<script>swal("Status!","Unble to Add New Class.","error"); </script>';
    }else{
              ...
              <div class="card mt-4">
                <div class="card-header pb-0 p-3">
                 ...
                 <?php
                   if(isset($cls)){
                    ?>
                <a class="btn bg-gradient-primary mb-0" href="manageclass.php"><i class="material-icons text-sm"></i>Reset</a>
                    <?php
                   }                   
                   ?>
                    </div>
                      ...
                      <div class="card card-body border card-plain border-radius-lg  " > 
                       ...
                       if(mysqli_num_rows($sql)>0){
                        ...
                        <div class="col-md-12 mb-md-0 mb-4 event-item">
                          ...
                          <p><b>Class Incharge: </b><b style="float:right"><?= $getInchange['staff_name'];?> (<?=$getInchange['staff_role']?>) in <?=$getInchange['subject']?></b></p>   
                          <div class="col-12 text-end"> 
                          <a class="btn bg-gradient-primary mb-0" href="manageclass.php?cls=<?= $row_class['id']?>"><i class="material-icons text-sm"></i>update</a>
                         </div>
                    ...
                    <div class="col-md-6 mb-md-0 mb-4">
                      <div class="card card-body border card-plain border-radius-lg  " style="overflow-y: scroll;min-height: 300px; max-height: 500px;"> 
                       ...
                       <div class="mb-3">
                          ...
                          <input type="text"  name="class_name"class="form-control form-control-lg" value="<?=$class_name ?>"  placeholder="  Name">
                        </div> 
                        <div class="mb-3">
                          ...
                          <select name="incharge_id" class="form-control form-control-lg"   >
                            ...
                            ?> 
                            <option value="<?=$row['staff_id']?>" <?php if($row['staff_id']==$incharge_id)echo "selected  " ?>  ><?=$row['staff_name']?>  (<?=$row['staff_role']?>) in (<?=$row['subject']?>)</option>
                              <?php }?>
                       ...
                       <div class="mb-3 text-end">
                         <?php 
                          if(isset($cls)){
                            ?>
                              <input style="display:none;" type="number" class="form-control form-control-lg" value="<?=$cls ?>"  name="cls" required>
                              <button class="btn bg-gradient-primary mb-0" name="update" ><i class="material-icons text-sm"></i>Update Class</button>
                            <?php
                          }else{
                            ?>
                            <button class="btn bg-gradient-primary   mb-0" name="new" ><i class="material-icons text-sm"></i>New Class</button>
                            <?php
                          }                
                          ?>
                          </div>
