...
if(isset($_POST['new'])){
    ...
    if(!mysqli_query($conn,$sql))  {
    echo'<script>swal("Status!","Unble to Add New Student.","error"); </script>';
    }else{
              ...
              <div class="card mt-4">
                <div class="card-header pb-0 p-3">
                 ...
                 <?php
                   if(isset($stid)){
                    ?>
                <a class="btn bg-gradient-primary mb-0" href="managestudent.php"><i class="material-icons text-sm"></i>New</a>
                    <?php
                   } else{
                    ?>
                   <a class="btn bg-gradient-primary mb-0" href="students.php"><i class="material-icons text-sm"></i>Choose For Update</a>
                  <?php
                  }                   
                   ?>
                    </div>
                    ...
                    <div class="col-md-6 mb-md-0 mb-4">
                      <div class="card card-body border card-plain border-radius-lg  " style="overflow-y: scroll;min-height: 300px; max-height: 500px;"> 
                       ...
                       <div class="mb-3">
                          ...
                          <input type="text"  name="student_name"class="form-control form-control-lg" value="<?=$student_name ?>"  placeholder="  Name">
                        </div>
                        <div class="mb-3">
                          <label  class="form-label">Email</label>
                          <input type="email" name="student_email" class="form-control form-control-lg" value="<?=$student_email ?>" placeholder="  Email">
                        </div>
                        <div class="mb-3">
                          <label  class="form-label">Phone</label>
                          <input type="number"  name="student_phone" class="form-control form-control-lg" value="<?=$student_phone ?>" placeholder="  Phone">
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" name="student_roll_no" class="form-control form-control-lg" value="<?=$student_roll_no ?>" placeholder="  Roll No.">
                        </div>
                        <div class="mb-3">
                       ...
                       <div class="mb-3 text-end">
                         <?php 
                          if(isset($stid)){
                            ?>
                              <input style="display:none;" type="number" class="form-control form-control-lg" value="<?=$stid ?>"  name="stid" required>
                              <button class="btn bg-gradient-primary mb-0" name="update" ><i class="material-icons text-sm"></i>Update Student</button>
                            <?php
                          }else{
                            ?>
                            <button class="btn bg-gradient-primary   mb-0" name="new" ><i class="material-icons text-sm"></i>New Student</button>
                            <?php
                          }                
                          ?>
                          </div>
